    ...
    <section className="mx-auto w-full max-w-6xl px-6 md:px-10">
      <Paper>
        <div className="grid items-center gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(360px,560px)] lg:gap-10">
          ...
          <div className="relative aspect-[800/472] overflow-hidden rounded-[24px] border border-zinc-200/80 bg-zinc-950 shadow-[0_24px_60px_-36px_rgba(15,23,42,0.75)] dark:border-zinc-700/80">
